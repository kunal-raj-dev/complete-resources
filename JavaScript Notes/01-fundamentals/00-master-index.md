...
Because `.fill()` assigns the exact same array object reference to every row. Mutating row 0 (`grid[0].push(1)`) modifies the shared instance, reflecting across all 3 rows.
</details>
