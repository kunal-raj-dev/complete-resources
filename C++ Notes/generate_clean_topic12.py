...
# 01
notes_data["01_recursion_basics_to_advanced_part1.md"] = """# Lecture 42: Recursion Basics: Call Stack, Induction & Recurrence
...
print(f"Generated 01 data, length {len(notes_data['01_recursion_basics_to_advanced_part1.md'])}")
